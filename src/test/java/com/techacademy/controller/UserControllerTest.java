...
class UserControllerTest {
    ...
    void testGetList() throws Exception {
        ...
        // 1件目の検証
        User uesr1 = user.get(0);
        assertEquals(uesr1.getId(), 1);
        assertEquals(uesr1.getName(), "キラメキ太郎");

        // 2件目の検証
        User uesr2 = user.get(1);
        assertEquals(uesr2.getId(), 2);
        assertEquals(uesr2.getName(), "キラメキ次郎");

        // 3件目の検証
        User uesr3 = user.get(2);
        assertEquals(uesr3.getId(), 3);
        assertEquals(uesr3.getName(), "キラメキ花子");
    }
}
